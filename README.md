...
Hey, I'm Donovan this is the first tutorial for setting up osTicket. This first tutorial showcases the prerequisites and installation.<br />


<h2>What is osTicket?</h2>
osTicket is a free open source help desk ticketing system. It merges email, phone, and web-based inquiries, then molds them into a simple, easy-to-use multi-user web interface. You can view, store and manage all support tickets and replies in one location, while having a real time log of all work done on current and past tickets.
